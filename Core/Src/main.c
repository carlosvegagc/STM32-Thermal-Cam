...
/* Definitions for app_msg_queue */
osMessageQueueId_t app_msg_queueHandle;
const osMessageQueueAttr_t app_msg_queue_attributes = {
  .name = "app_msg_queue"
};
/* Definitions for char_queue */
osMessageQueueId_t char_queueHandle;
const osMessageQueueAttr_t char_queue_attributes = {
  .name = "char_queue"
};
/* Definitions for cpu_temp_queque */
osMessageQueueId_t cpu_temp_quequeHandle;
const osMessageQueueAttr_t cpu_temp_queque_attributes = {
  .name = "cpu_temp_queque"
};
/* Definitions for frameRate_queue */
osMessageQueueId_t frameRate_queueHandle;
const osMessageQueueAttr_t frameRate_queue_attributes = {
  .name = "frameRate_queue"
};
/* Definitions for cameraI2CMutex */
osMutexId_t cameraI2CMutexHandle;
const osMutexAttr_t cameraI2CMutex_attributes = {
  .name = "cameraI2CMutex"
};
...
/* Definitions for frameSem */
osSemaphoreId_t frameSemHandle;
const osSemaphoreAttr_t frameSem_attributes = {
  .name = "frameSem"
};
/* Definitions for updateBitmap */
osEventFlagsId_t updateBitmapHandle;
const osEventFlagsAttr_t updateBitmap_attributes = {
  .name = "updateBitmap"
};
/* Definitions for eventButtonPressed */
osEventFlagsId_t eventButtonPressedHandle;
const osEventFlagsAttr_t eventButtonPressed_attributes = {
  .name = "eventButtonPressed"
};
/* USER CODE BEGIN PV */
...
int main(void)
{
  ...
  osKernelInitialize();
  /* Create the mutex(es) */
  /* creation of cameraI2CMutex */
  cameraI2CMutexHandle = osMutexNew(&cameraI2CMutex_attributes);
  ...
  /* creation of frameSem */
  frameSemHandle = osSemaphoreNew(1, 1, &frameSem_attributes);
  ...
  temp_queueHandle = osMessageQueueNew (6, sizeof(float), &temp_queue_attributes);

  /* creation of app_msg_queue */
  app_msg_queueHandle = osMessageQueueNew (16, sizeof(App_Message *), &app_msg_queue_attributes);

  /* creation of char_queue */
  char_queueHandle = osMessageQueueNew (20, sizeof(char), &char_queue_attributes);

  /* creation of cpu_temp_queque */
  cpu_temp_quequeHandle = osMessageQueueNew (4, sizeof(float), &cpu_temp_queque_attributes);

  /* creation of frameRate_queue */
  frameRate_queueHandle = osMessageQueueNew (2, sizeof(uint8_t), &frameRate_queue_attributes);
  ...
  cli_taskHandle = osThreadNew(cli_processing_task, NULL, &cli_task_attributes);

  /* creation of frame */
  frameHandle = osThreadNew(frame_task, NULL, &frame_attributes);

  /* creation of cpu_temp */
  cpu_tempHandle = osThreadNew(cpuTemperatureTask, NULL, &cpu_temp_attributes);

  /* USER CODE BEGIN RTOS_THREADS */
  /* add threads, ... */
  /* USER CODE END RTOS_THREADS */

  /* creation of updateBitmap */
  updateBitmapHandle = osEventFlagsNew(&updateBitmap_attributes);

  /* creation of eventButtonPressed */
  eventButtonPressedHandle = osEventFlagsNew(&eventButtonPressed_attributes);
...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin){
	...
	//Send the event for processing the button touch
	osEventFlagsSet (eventButtonPressedHandle, 0x00000001U);
}
...
/* USER CODE BEGIN Header_frame_task */
/**
* @brief Function implementing the frame thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_frame_task */
__weak void frame_task(void *argument)
{
  /* USER CODE BEGIN frame_task */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END frame_task */
}

/* USER CODE BEGIN Header_cpuTemperatureTask */
/**
* @brief Function implementing the cpu_temp thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_cpuTemperatureTask */
__weak void cpuTemperatureTask(void *argument)
{
  /* USER CODE BEGIN cpuTemperatureTask */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END cpuTemperatureTask */
}
